...
@if($viewType == 'default')
    ...
    <div style="margin-top:15px;">
        ...
        <div class="message-card" data-id="{{ $id }}">
            <div class="avatar av-m mr-2" style="background-image: url('{{ asset('/storage/user_profile/IMG_20200304_135846-min_1585545428.jpg') }}');"></div>
...
@if($viewType == 'sender')
    ...
    <div class="message-card mc-sender" data-id="{{ $id }}">
        <div class="avatar av-m ml-2" style="background-image: url('{{ asset('/storage/user_profile/IMG_20200304_135846-min_1585545428.jpg') }}');"></div>
        <p>{!! ($message == null && $attachment != null && @$attachment[2] != 'file') ? $attachment[1] : nl2br($message) !!}
            @if(@$attachment[2] == 'file')
